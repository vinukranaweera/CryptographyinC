...
def get_directory(dir): # Retrieves all files in a directory and returns them as a list
    files_list = []
...
def get_arguments(args): # Handles the command line arguments
    if args.generate:
